...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="card mt-3">
        ...
        @endif
        <div class="card-body">
            <form method="post" action="{{ url('user/pengguna') }}">
                @csrf
                <div class="form-group">
                    <label>Nama Menu</label>
                    <input type="text" class="form-control" name="prodname" value="{{ Session::get('prodname') }}" required>
                </div>
                <br>
                <div class="mb-3">
                  <label>Harga</label>
                  <input type="numeric" name="harga" class="form-control" name="harga" value="{{ Session::get('harga') }}" placeholder="Rp" required>
                </div>
                <div class="form-group">
                    <label>Kategori</label>
                    <select class="form-control" name="kategori">
                      <option value="{{ Session::get('kategori') }}">Pilih</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status">
                    <option value="{{ Session::get('status') }}">Pilih</option>
                ...
                <div class="form-group">
                <label>Foto</label>
                <input type="file" class="form-control" name="file" value="{{ Session::get('file') }}" required>
                <div>
