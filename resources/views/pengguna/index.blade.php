...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="pb-3">
        <form class="d-flex" action="{{ url('user/pengguna')}}" method="GET">
      ...
      <a href="/user/pengguna/create" class="btn btn-primary"><span data-feather="plus"></span>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td>{{ $item->role }}</td>
          <td>
            <a href="{{ url('user/pengguna/'.$item->name.'/edit') }}" class="btn btn-warning"><span data-feather="edit"></span></a>
              <form onsubmit="return confirm('Yakin Anda Ingin Menghapus Kategori Ini?')" class='d-inline' action="{{ url('user/pengguna/'.$item->name) }}"
              method="POST">
              @csrf
              @method('DELETE')
